...
function Slides() {
  const {data} = useQuery(['slides'], fetchSlides);
    ...
    <div className='carousel-inner relative overflow-hidden w-full'>
      ...
      >
        <div
          ...
          style={{
            backgroundImage: `url(${Slide[0].url_image})`,
            backgroundPosition: 'top',
          }}
        >
          <div className='container mx-auto'>
            <div className='flex flex-col w-full lg:w-1/2 md:ml-16 items-center md:items-start px-6 tracking-wide'>
              <p className='text-black text-2xl my-4'>{Slide[0].text}</p>
              <a
      ...
      >
        <div
          className='h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-right'
          style={{
            backgroundImage: `url(${Slide[1].url_image})`,
          }}
        >
          <div className='container mx-auto'>
            <div className='flex flex-col w-full lg:w-1/2 md:ml-16 items-center md:items-start px-6 tracking-wide'>
              <p className='text-black text-2xl my-4'>{Slide[1].text}</p>
              <a
                className='text-xl inline-block no-underline border-b border-gray-600 leading-relaxed hover:text-black hover:border-black'
                href='#catalog'
              >
      ...
      >
        <div
          ...
          style={{
            backgroundImage: `url(${Slide[2].url_image})`,
            backgroundPosition: 'top',
          }}
        >
          <div className='container mx-auto'>
            <div className='flex flex-col w-full lg:w-1/2 md:ml-16 items-center md:items-start px-6 tracking-wide'>
              <p className='text-black text-2xl my-4'>{Slide[2].text}</p>
              <a
                className='text-xl inline-block no-underline border-b border-gray-600 leading-relaxed hover:text-black hover:border-black'
                href='#catalog'
              >
